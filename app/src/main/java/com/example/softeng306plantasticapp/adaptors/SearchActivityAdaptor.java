...
public class SearchActivityAdaptor extends RecyclerView.Adapter<SearchActivityAdaptor.ViewHolder> {
    private Context context;
    private ArrayList<IItem> items;
    private OnItemClickListener listener;

    public SearchActivityAdaptor(Context context, ArrayList<IItem> items) {
        this.context = context;
        this.items = items;
    }
    @NonNull
    @Override
    public SearchActivityAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // inflate layout here (give it the look)
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.recycler_item_row, parent, false);

        return new SearchActivityAdaptor.ViewHolder(view, listener);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchActivityAdaptor.ViewHolder holder, int position) {
